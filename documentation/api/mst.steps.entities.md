...
# <kbd>module</kbd> `mst.steps.entities`



## Table of Contents
- [`extract_entities`](./mst.steps.entities.md#function-extract_entities)
- [`extract_persons`](./mst.steps.entities.md#function-extract_persons)
- [`get_entity_model`](./mst.steps.entities.md#function-get_entity_model)
- [`group_by_label`](./mst.steps.entities.md#function-group_by_label)
- [`merge_duplicate_texts`](./mst.steps.entities.md#function-merge_duplicate_texts)
- [`merge_similar_texts`](./mst.steps.entities.md#function-merge_similar_texts)



---

<a href="https://github.com/geraldthewes/multistep-transcriber/blob/main/mst/steps/entities.py#L18"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square" /></a>

## <kbd>function</kbd> `get_entity_model`

```python
get_entity_model(model_name: str = 'urchade/gliner_medium-v2.1') → GLiNER
```
...
- <b>`model_name`</b>: Name of the GLiNER model to load.
...
<a href="https://github.com/geraldthewes/multistep-transcriber/blob/main/mst/steps/entities.py#L32"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square" /></a>
...
<a href="https://github.com/geraldthewes/multistep-transcriber/blob/main/mst/steps/entities.py#L62"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square" /></a>
...
<a href="https://github.com/geraldthewes/multistep-transcriber/blob/main/mst/steps/entities.py#L101"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square" /></a>
...
- <b>`data`</b> (Dict[str, List[Dict[str, Any]]]): Entities grouped by label.
- <b>`config`</b>: EntityConfig instance. If None, uses defaults.
- <b>`llm_config`</b>: LLMConfig instance. If None, uses defaults.
...
<a href="https://github.com/geraldthewes/multistep-transcriber/blob/main/mst/steps/entities.py#L145"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square" /></a>
...
<a href="https://github.com/geraldthewes/multistep-transcriber/blob/main/mst/steps/entities.py#L283"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square" /></a>
